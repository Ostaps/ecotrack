                ...
                {filteredShipments.length === 0 ? (
                  <tr>
                    <td colSpan="8" className="px-6 py-12 text-center">
                      <div className="text-sm font-medium text-gray-900">No shipments match this status.</div>
                      <div className="mt-1 text-sm text-gray-500">Choose another filter or create a new shipment.</div>
                    </td>
                  </tr>
